...
export default function Register() {
    ...
    <Form.Group as={Col} controlId="userFirstname">
        ...
        <Form.Control type="text" placeholder="Armando" required></Form.Control>
    </Form.Group>
    ...
    <Form.Group className="mb-3" controlId="celphone">
        ...
        <Form.Control type="tel" placeholder="3815879021"></Form.Control>
    </Form.Group>
    </Row>
    <Row>
        ...
        <Col>
        <Form.Floating>
            <Form.Control id="floatingRegion" type="text" placeholder="Tucumán"/>
            <label htmlFor="floatingRegion">Provincia</label>
        </Form.Floating>
        </Col>
        <Col>
        <Form.Floating>
            <Form.Control id="floatingZipCode" type="number" placeholder="4000" min='0'/>
